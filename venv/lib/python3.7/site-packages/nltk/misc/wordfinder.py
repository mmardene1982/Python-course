...
def wordfinder(words, rows=20, cols=20, attempts=50, alph='ABCDEFGHIJKLMNOPQRSTUVWXYZ'):
    ...
    for word in words:
        ...
        for attempt in range(attempts):
            r = random1.randint(0, len(word))
            dir = random1.choice([1, 2, 3, 4])
            x = random1.randint(0, rows)
            y = random1.randint(0, cols)
            if dir == 1:
                x += r
                y += r
            elif dir == 2:
